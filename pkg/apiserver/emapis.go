...
import (
	...
	specificapi "github.com/batazor/k8s-custom-metric/pkg/apiserver/installer"
	"github.com/batazor/k8s-custom-metric/pkg/provider"
	metricstorage "github.com/batazor/k8s-custom-metric/pkg/registry/external_metrics"
