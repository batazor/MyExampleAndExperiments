...
class NoteRepository extends EventEmitter {
  constructor () {
    ...
    this.ref = new Firebase('https://intense-torch-7218.firebaseio.com/') // will have same result as new Firebase('https://<YOUR-FIREBASE-APP>.firebaseio.com/').child('notes')
